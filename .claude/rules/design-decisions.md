...
| **Marcador `V32_UI_END` duplicado no HTML** | Bug conhecido do builder com exceção nominal KI-1 (remoção prevista: demanda própria via máquina SDD). Não reportar de novo; não corrigir fora da demanda. |
