...
| **Evidência binária (~103 MB) versionada** | Herança das fases 5.0–5.2, pinada pelos manifestos de fase. Decisão original — permanecer até a migração desenhada (Onda 4/R11) — registrada aqui e superada — migração executada pela demanda 007 (PR #20, 2026-08-25) (`specs/007-migracao-evidencia/`): os 4 acervos (`evidence_p50`/`evidence_p51`/`evidence_p52`/`evidence_unset`, 406 arquivos) migraram para Releases nominais (`evidence-p50`/`evidence-p51`/`evidence-p52`/`evidence-unset`) em `oflavioc/quickscan-secops`, com verificabilidade preservada por manifesto-ponte pinado (`.claude/verify/evidence_bridge.json`) e pelo gate `evidence-bridge`. `evidence_v322` (gate V322-DOC3) fica versionado por decisão distinta. Os 3 ZIPs da raiz (gates S64/S74/S113) — que a 007 registrou como "migração de escopo posterior" — **estão em migração pela demanda 008** (`specs/008-migracao-zips/`, branch `feature/008-migracao-zips`): manifesto-ponte estendido para acervo-arquivo (`evidence-47`/`evidence-48`/`evidence-487`, mesma âncora `62590b5927496a61ab31dd476d46b03624546560` da 007, release-alvo `evidence-v32`) e gate `evidence-bridge` generalizado já commitados (`314f466`, `fcbe5e5`), com red provado e commitado (`5bafacd`, gates ZB-3/ZB-4/M-ZB5/M-ZB6). **Estado nesta escrita (2026-08-27, wave 4 da 008)**: o release `evidence-v32` ainda **não foi publicado** (T006 aguarda confirmação operacional do proprietário) e os 3 ZIPs ainda **não foram desindexados** (T010 pendente) — seguem versionados até lá; os oráculos S64/S74/S113 ainda leem o arquivo local (refatoração para a âncora é T007, também pendente). Trilha: decisão original permanece citável acima; a consumação da 007 está registrada em `relatorio-final.md`; a consumação da 008 (publicação + desindexação + repin), quando fechada, será registrada no relatório final próprio da demanda — até lá, esta linha reflete o estado real, não um resultado antecipado. Evidência NOVA segue R11. |
