...
def main(tag):
    ...
    print("     com o smoke das correcoes que entram e o payload M41 medido ASSIM:")
    print("")
    print("       node harness_m41_v313.js quickscan_secops_soccmm_v3_2_dev.html \\")
    print("            --compare v3_1_3_functional_snapshot.json")
    print("")
    print("     O `--compare` NAO e opcional (EA-54): sem ele o harness escreve o")
    print("     proprio v3_1_3_functional_snapshot.json, que e classe `frozen`.")
