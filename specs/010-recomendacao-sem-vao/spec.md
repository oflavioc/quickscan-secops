...
| **Alcance** | Redação de **C6**, **C7**, **C8**, **C9**, **C10** e **C12**; a linha **D010-F3** e a linha **nova D010-F4** da tabela de fixtures; os §1 e §4 de "Comportamento especificado"; dois mutantes novos (**M18**, **M19**) sobre gate que já existe. Nenhum gate nasce ou morre, nenhum id `D010-*` muda, nenhuma contagem de suíte congelada é afetada. `D010-F1`, `F1b` e `F2` permanecem **byte-idênticas** |
...
declarado*, nunca como par vazio.
...
sem bridge novo (**E7**, R-3 preservada).
