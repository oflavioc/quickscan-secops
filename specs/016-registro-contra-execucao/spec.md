...
[FAIL]  <global historico-raso — linha a EXTRAIR de fecho.py:_impedimento depois do green (E016-8): pendência nomeada, fecha no spec-validate do fix>      ← só sob clone raso nomeado pelo leitor (E016-8)
